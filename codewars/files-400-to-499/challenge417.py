...
def shark(pontoon_distance, shark_distance, you_speed, shark_speed, dolphin):
    # If there's a dolphin, the shark swims at half speed.
    effective_shark_speed = shark_speed / 2 if dolphin else shark_speed

    # Time for each to reach you/pontoon.
    you_time = pontoon_distance / you_speed
    shark_time = shark_distance / effective_shark_speed
